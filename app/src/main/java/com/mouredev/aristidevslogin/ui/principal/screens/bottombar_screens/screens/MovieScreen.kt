...
@Composable
fun MovieScreen(viewModel: MoviesViewModel, cartViewModel : CartViewModel, navigationController: NavHostController) {
    ...
    LaunchedEffect(searchQuery.value, movieList) {
        filteredMovies.clear()
        filteredMovies.addAll(
            movieList.filter { it.title.contains(searchQuery.value, ignoreCase = true) }
        )
    }
